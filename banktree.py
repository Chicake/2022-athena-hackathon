...
# Bank side
print("*Moved to " + bank + " app's round-up pot*")
code4 = 1234
...
enteredCode = int(input("Please enter your 4-digit code: ")) #1234
while enteredCode != code4:
  print("Unsuccessful. Enter your code again.")
  enteredCode = int(input("Please enter your 4-digit code: "))
else:
  print("Transfer successful")

print("*Click on Banktree button*")

# Banktree side
print("*Transferred back to Banktree app*")
if passion=="environment":
